...
namespace Unity.Netcode.Editor
{
    ...
    public class NetworkRigidbodyEditor : UnityEditor.Editor
    {
        ...
        private SerializedProperty m_FixedUpdateProperty;
        ...
        public void OnEnable()
        {
            ...
            m_FixedUpdateProperty = serializedObject.FindProperty(nameof(NetworkRigidbody.RunOnFixedUpdate));
        }
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.PropertyField(m_FixedUpdateProperty);
